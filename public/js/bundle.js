    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            urlType = type === "true" ? "signup" : "signin";
            _context.prev = 1;
            _context.next = 4;
          ...
          case 4:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Welcome");
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Goodbye");
              location.assign("/");
            }
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoiZ2hvc3RlZDM0IiwiYSI6ImNsNnF5MHkzajAyZ2kzbm83eXRlenZhYmUifQ.ogcNbzLpyT6o3MMw7TcUXQ";
  ...
  _regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            urlType = type === "password" ? "password" : "me";
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)({
              method: "PATCH",
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe("pk_test_51LXe2DI3U5lmy7K0GYsbibG7n9ZPhfDCXfaqpAFmYAtuFj6lhZWS1ltqeZZYTjoUEOqOm7AqTrzTXXTGqD05oztQ003sjh9SpU"); // Get session from server
          ...
          case 4:
            ...
            console.log(session); // await stripe.redirectToCheckout({
...
if (updateData) {
  updateData.addEventListener("submit", function (e) {
    ...
    form.append("email", email);
    form.append("photo", photo);
    (0, _update.updateSettings)(form, "data");
  });
}
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              newPasswordConfirm = document.querySelector("#password-confirm").value;
              _context.next = 7;
            ...
            case 7:
              ...
              document.querySelector("#password-current").value = document.querySelector("#password").value = document.querySelector("#password-confirm").value = "";
